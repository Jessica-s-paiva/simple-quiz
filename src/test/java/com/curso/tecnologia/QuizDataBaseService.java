...
public class QuizDataBaseService {
    ...
    public ArrayList<Question> showAllQuestions(){
        ...
        questionsList.add(new Question( "Movie",  "Qual é o filme mais premiado da história do Oscar?",  "O Senhor dos Anéis: O Retorno do Rei"));
        questionsList.add(new Question("Jogos", "Qual é o jogo mais vendido de todos os tempos?", "Minecraft"));
        questionsList.add(new Question("Ciência", "Quem foi o inventor da teoria da relatividade?", "Albert Einstein"));
        questionsList.add(new Question("Geografia", "Qual é a capital da França?", "Paris"));
        questionsList.add(new Question("História", "Em que ano ocorreu a Revolução Francesa?", "1789"));
        ...
        questionsList.add(new Question("Música", "Qual é a banda de rock mais vendida da história?", "The Beatles"));
